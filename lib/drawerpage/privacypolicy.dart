        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('With Service Providers: We may share your information with our general dentists, specialists and consultants.'),
              SizedBox(height: 10),
              ...
              Align(child: Text('قد نشارك معلوماتك التي نجمعها للأغراض التالية:'),alignment: Alignment.topRight),
              Align(child: Text('مع مقدمي الخدمات: قد نشارك معلوماتك مع أطباء الأسنان العامين والمتخصصين والاستشاريين.'),alignment: Alignment.topRight,),
              SizedBox(height: 20),
