    ...
    if (_value == 1) {
      ...
      return Column(
        children: [
          ...
          Arab(
            boldtext: "• ",
            normal: "(أ) الترخيص أو البيع أو الإيجار أو الإيجار أو النقل أو التعيين أو التوزيع أو المضيف أو استغلال المواقع المشمولة تجاريا، دون موافقة كتابية صريحة من telesmile؛",
          ),
          Arab(
            boldtext: "• ",
            normal: "(ب) لا يجوز لك تعديل أو عمل أعمال مشتقة أو تفكيك أو ترجمة عكسية أو عكس مهندس أي جزء من المواقع المشمولة؛",
          ),
          Arab(
            boldtext: "• ",
            normal: "(ج) لا يجوز لك الوصول إلى المواقع المشمولة من أجل بناء خدمة مماثلة أو تنافسية؛",
          ),
          Arab(
            boldtext: "• ",
            normal: "(د) نسخ أو استنساخ أو توزيع أو إعادة نشر أو تنزيل أو عرض أو نشر أو إرسال بأي شكل أو بأي وسيلة من المواقع المشمولة، لأي غرض تجاري، دون موافقة خطية صريحة من البريدالإلكتروني؛",
          ),
          Arab(
            boldtext: "• ",
            normal: "(ه) استخدام المواقع المشمولة بأي طريقة تسبب أو قد تسبب ضررا للمواقع المغطاة أو تعوق توافر أو إمكانية الوصول إلى المواقع المشمولة أو بأي شكل من الأشكال غير قانوني أو غير قانوني أو احتيالي أو ضار، أو فيما يتعلق بأي غرض أو نشاط غير قانوني أو غير قانوني أو احتيالي أو ضار",
          ),
          Arab(
            boldtext: "• ",
            normal: "(و) القيام بأي أنشطة منهجية أو مؤتمتة لجمع البيانات على المواقع المشمولة أو فيما يتعلق بها دون موافقة خطية صريحة من  البريد الإلكتروني.",
          ),
        ],
      );
    }
